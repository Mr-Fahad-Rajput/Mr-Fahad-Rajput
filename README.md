...
<div align="center" style="width: 80%; margin: auto;">
  <!-- Container for the trophies and stats cards -->
  <div style="display: flex; flex-direction: column; align-items: center;">

    <!-- Trophy card with single and multiple trophies -->
    <div style="width: 60%; margin-bottom: 5%;">
      <img width="100%" src="https://github-profile-trophy.vercel.app/?username=mr-fahad-rajput&column=1&row=1&title=Commit&margin-w=15&theme=gruvbox&no-bg=true" alt="Single Trophy" />
      <img width="100%" src="https://github-profile-trophy.vercel.app/?username=ryo-ma&column=3&row=1&title=MultiLanguage,LongTimeUser,Experience&margin-w=15&theme=gruvbox&no-bg=true" alt="Multiple Trophies" />
    </div>
